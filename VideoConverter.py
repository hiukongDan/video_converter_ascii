...
if __name__ == "__main__":
    ...
    ttk.Label(root, text="Width: ").grid(column=0, row=11, padx=0, pady=0, sticky=tk.W)
    ...
    output_canvas_size_button.grid(column=0, row=12, padx=0, pady=0, sticky=tk.W)

    # font
    ttk.Label(root, text="Font:").grid(column=0, row=13, padx=0, pady=0, sticky=tk.W)
    ...
    # color
    ttk.Label(root, text="Font color:").grid(column=0, row=16, padx=0, pady=0, sticky=tk.W)
    ...
    tk.Entry(root, textvariable=font_R).grid(column=0, row=17, padx=0, pady=0, sticky=tk.W)
    ...
    font_color_button.grid(column=0, row=18, padx=0, pady=0, sticky=tk.W)


    # background color
    ttk.Label(root, text="Background color:").grid(column=0, row=19, padx=0, pady=0, sticky=tk.W)
    ...
    tk.Entry(root, textvariable=bg_R).grid(column=0, row=20, padx=0, pady=0, sticky=tk.W)
    ...
    bg_color_button.grid(column=0, row=21, padx=0, pady=0, sticky=tk.W)
